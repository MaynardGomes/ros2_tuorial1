...
class TurtleController(LifecycleNode): 
    def __init__(self):
    ...
    def on_configure(self, previous_state: LifecycleState):
        ...
        self.cmd_vel_publisher_ = self.create_lifecycle_publisher(Twist, self.turtle_name_ + "/cmd_vel", 10)
    ...
    def on_cleanup(self, previous_state: LifecycleState):
        ...
        self.kill_turtle()
        self.spawn_turtle_client_.destroy()
        self.kill_turtle_client_.destroy()
